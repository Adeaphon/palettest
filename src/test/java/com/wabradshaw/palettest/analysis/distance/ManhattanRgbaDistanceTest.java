...
/**
 * A set of tests for {@link ManhattanRgbaDistance}.
 */
public class ManhattanRgbaDistanceTest {

    ManhattanRgbaDistance function = new ManhattanRgbaDistance();
    ...
    public void testDistanceBlackWhite(){
        ...
        Tone b = getTone(255,255,255,255);
        double result = function.getDistance(a,b);
        assertEquals(255 * 3 , result, 0.000001);
    }
    ...
    public void testDistanceRedWhite(){
        ...
        Tone b = getTone(255,255,255,255);
        double result = function.getDistance(a,b);
        assertEquals(255 * 2 , result, 0.000001);
    }
    ...
    public void testDistanceCompoundWhite(){
        ...
        Tone b = getTone(255,255,255,255);
        double result = function.getDistance(a,b);
        assertEquals(35 + 5 + 49 , result, 0.000001);
    }
    ...
    public void testDistanceCompoundBlack(){
        ...
        Tone b = getTone(0,0,0,255);
        double result = function.getDistance(a,b);
        assertEquals(220 + 250 + 206 , result, 0.000001);
    }
    ...
    public void testDistanceTransparentBlack(){
        ...
        Tone b = getTone(220,250,206,0);
        double result = function.getDistance(a,b);
        assertEquals(220 + 250 + 206 + 255, result, 0.000001);
    }
    ...
    public void testDistanceTransparentWhite(){
        ...
        Tone b = getTone(220,250,206,0);
        double result = function.getDistance(a,b);
        assertEquals(35 + 5 + 49 + 255, result, 0.000001);
    }
